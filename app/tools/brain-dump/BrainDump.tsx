...
export default function BrainDump() {
  ...
  const handleClear = () => {
    trackEvent("tool_complete", { tool_name: "brain_dump", words_written: wordCount });
    setText("");
    setCleared(true);
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="flex justify-center mb-5">
            <ToolIcon name="brain-dump" size={28} containerSize={56} />
          </div>
          ...
          <textarea
            ...
            onChange={(e) => {
              if (!hasTrackedStart.current && e.target.value.length > 0) {
                trackEvent("tool_start", { tool_name: "brain_dump" });
